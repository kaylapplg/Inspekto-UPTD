...
const k3FieldGroups = [
  ...
  {
    title: 'Bahan Berbahaya & Ruang Terbatas',
    color: 'red',
    fields: [
...
const k4FieldGroups = [
  {
    title: 'Perusahaan Terdaftar BPJS Kesehatan',
    color: 'sky',
    fields: [
  ...
  {
    title: 'Jumlah Tenaga Kerja BPJS Kesehatan',
    color: 'amber',
    fields: [
...
// Struktur grup field K7 — mengikuti pola form K4
const k7FieldGroups = [
  {
    title: 'Data Penerbitan Perijinan, Keterangan Layak, Pengesahan, Rekomendasi K3',
    color: 'sky',
    fields: [
      ['pesawat_uap', 'Pesawat Uap'],
      ...
      ['ptp', 'PTP'],
      ['listrik', 'Listrik'],
      ['elevator', 'Elevator dan Eskalator'],
      ['petir', 'Petir'],
      ['kebakaran', 'Kebakaran'],
      ['konstruksi', 'Kontruksi Bangunan'],
      ['klinik', 'Klinik Pers./Pelayanan Kesehatan Kerja'],
      ['lingkungan', 'Lingkungan Kerja'],
      ['kimia', 'Bahan Kimia Berbahaya'],
      ['makan', 'Sarana Penyelengaraan Makan'],
      ['p2k3', 'P2K3'],
    ],
  },
];
...
const App = () => {
  ...
  const menuItems = [
    { id: 'K1', short: '', label: 'Pengawas & Ketenagakerjaan', icon: 'M17.982 18.725A7.488 7.488 0 0012 15.75a7.488 7.488 0 00-5.982 2.975m11.964 0a9 9 0 10-11.964 0m11.964 0A8.966 8.966 0 0112 21a8.966 8.966 0 01-5.982-2.275M15 9.75a3 3 0 11-6 0 3 3 0 016 0z' },
    { id: 'K2', short: '', label: 'Profil Perusahaan & TK', icon: 'M3.75 21h16.5M4.5 3h15M5.25 3v18m13.5-18v18M9 6.75h1.5m-1.5 3h1.5m-1.5 3h1.5m3-6H15m-1.5 3H15m-1.5 3H15M9 21v-3.375c0-.621.504-1.125 1.125-1.125h3.75c.621 0 1.125.504 1.125 1.125V21' },
    { id: 'K3', short: '', label: 'Wajib Lapor Ketenagakerjaan', icon: 'M9 12h6m-6 3h6m-7.5 6.75h9A2.25 2.25 0 0018.75 19.5V6.31a2.25 2.25 0 00-.659-1.591L14.29 1.09A2.25 2.25 0 0012.7.75H7.5A2.25 2.25 0 005.25 3v16.5A2.25 2.25 0 007.5 21z' },
    { id: 'K4', short: '', label: 'Jaminan Sosial (BPJS)', icon: 'M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285z' },
    { id: 'K5', short: '', label: 'Penggunaan TKA', icon: 'M12 21a9 9 0 100-18 9 9 0 000 18zM3.6 9h16.8M3.6 15h16.8M11.5 3a17 17 0 000 18M12.5 3a17 17 0 010 18' },
    { id: 'K6', short: '', label: 'Norma', subMenus: [
      { id: '6A', label: ' - Kelembagaan' },
      { id: '6B', label: ' - Personil K3' },
      { id: '6C', label: ' - Penghargaan' },
      { id: '6D', label: ' - Kasus Kecelakaan' }
    ...
    { id: 'K7', short: '', label: 'Pes. Uap & Bejana Tekan', icon: 'M12 3v2.25m6.364.386l-1.591 1.591M21 12h-2.25m-.386 6.364l-1.591-1.591M12 18.75V21m-6.364-2.386l1.591-1.591M3 12h2.25m.386-6.364L7.227 7.227M12 8.25a3.75 3.75 0 100 7.5 3.75 3.75 0 000-7.5z' },
    { id: 'K8', short: '', label: 'Mekanik & Listrik', subMenus: [
      { id: '8A', label: ' - Pes. Tenaga Produksi' },
      { id: '8B', label: ' - Pes. Angkat Angkut' },
      { id: '8C', label: ' - Instalasi Listrik' }
    ], icon: 'M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z' },
    { id: 'K9', short: '', label: 'Kesehatan Kerja', subMenus: [
      { id: '9A', label: ' - Fasilitas Yankes' },
      { id: '9B', label: ' - Lingkungan Kerja' }
    ], icon: 'M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z' },
    { id: 'K10', short: '', label: 'Nota Pemeriksaan', icon: 'M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z' },
  ];
  ...
  const renderDetailPanelK7 = (item) => {
    const sections = [
      {
        title: 'Penerbitan Perijinan',
        color: 'text-[#071A2F]',
        dot: 'bg-[#071A2F]',
        fields: [
          ['Pesawat Uap', 'pesawat_uap'],
          ['Bejana Tekan', 'bejana_tekan'],
          ['PAA', 'paa'],
          ['PTP', 'ptp'],
          ['Listrik', 'listrik'],
          ['Elevator dan Eskalator', 'elevator'],
          ['Petir', 'petir'],
        ],
      },
      {
        title: 'Keterangan Layak / Pengesahan',
        color: 'text-yellow-600',
        dot: 'bg-yellow-500',
        fields: [
          ['Kebakaran', 'kebakaran'],
          ['Kontruksi Bangunan', 'konstruksi'],
          ['Klinik Pers./Pelayanan Kesehatan Kerja', 'klinik'],
          ['Lingkungan Kerja', 'lingkungan'],
        ],
      },
      {
        title: 'Rekomendasi K3',
        color: 'text-green-600',
        dot: 'bg-green-500',
        fields: [
          ['Bahan Kimia Berbahaya', 'kimia'],
          ['Sarana Penyelengaraan Makan', 'makan'],
          ['P2K3', 'p2k3'],
        ],
      },
    ];
          ...
          <div className="bg-slate-100 p-6 shadow-inner">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              {sections.map((section) => (
                <div key={section.title} className="bg-white p-4 rounded-md shadow-sm border border-slate-200">
                  <h5 className={`text-xs font-bold ${section.color} uppercase mb-3 flex items-center gap-2`}>
                    <div className={`w-2 h-2 ${section.dot} rounded-full`}></div>
                    {section.title}
                  </h5>
                  <div className="space-y-2 text-sm">
                    {section.fields.map(([label, key]) => (
                      <div key={key} className="flex justify-between items-center gap-3">
                        <span className="text-slate-500 leading-5">{label}</span>
                        <span className="font-medium text-slate-800 shrink-0">{Number(item[key] ?? 0).toLocaleString()}</span>
                      </div>
                    ))}
                  </div>
                </div>
              ...
              <div className="bg-white p-4 rounded-md shadow-sm border border-slate-200">
                <h5 className="text-xs font-bold text-purple-600 uppercase mb-3 flex items-center gap-2">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-medium text-slate-800">{item.bulan ?? '-'}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-slate-500">Tahun</span>
                    <span className="font-medium text-slate-800">{item.tahun ?? '-'}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-slate-500">Kabupaten/Kota</span>
                    <span className="font-medium text-slate-800 text-right">{getKotaName(item)}</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="px-5 py-5 flex items-center gap-3 border-b border-white/10">
        ...
        <div className="min-w-0">
          <h1 className="text-base font-bold tracking-tight leading-tight truncate">
            Inspekto <span className="text-yellow-400 font-bold">UPTD</span>
          </h1>
  ...
  const renderStructuredEditPage = () => {
      ...
      return (
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200/70">
          ...
          <form className="p-6 space-y-8" onSubmit={saveEdit}>
            <section>
              <h4 className="text-sm font-bold text-[#071A2F] mb-4 pb-2 border-b-2 border-yellow-400 uppercase tracking-wide">Informasi Umum</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <section>
              <h4 className="text-sm font-bold text-[#071A2F] mb-4 pb-2 border-b-2 border-yellow-400 uppercase tracking-wide">Data Pengawas Ketenagakerjaan</h4>
      ...
      return (
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200/70">
          ...
          <form className="p-6 space-y-8" onSubmit={saveEdit}>
            ...
            <section>
              <h4 className="text-sm font-bold text-[#071A2F] mb-4 pb-2 border-b-2 border-yellow-400 uppercase tracking-wide">Jumlah Tenaga Kerja</h4>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <section>
                <h4 className="text-sm font-bold text-[#071A2F] mb-4 pb-2 border-b-2 border-yellow-400 uppercase tracking-wide">Kategori Perusahaan</h4>
              ...
              <section>
                <h4 className="text-sm font-bold text-[#071A2F] mb-4 pb-2 border-b-2 border-yellow-400 uppercase tracking-wide">Kelembagaan & Hub. Industrial</h4>
            ...
            <section>
              <h4 className="text-sm font-bold text-[#071A2F] mb-4 pb-2 border-b-2 border-yellow-400 uppercase tracking-wide">Status Perusahaan & Penghargaan</h4>
    ...
    if (editData.api === 'k7-perizinan') {
      return (
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200/70">
          <div className="p-5 border-b border-slate-100 bg-slate-50/60">
            <h3 className="font-semibold text-slate-800">Form Edit Data K7</h3>
            <p className="text-xs text-slate-500 mt-1">Perijinan / Keterangan Layak / Pengesahan / Rekomendasi K3</p>
          </div>
          <form className="p-6 space-y-8" onSubmit={saveEdit}>
            <section>
            ...
            {k7FieldGroups.map((group) => {
              ...
              return (
                <section key={group.title}>
                  ...
                  <div className={`grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 p-4 border rounded-lg ${colors.box}`}>
                    {group.fields.map(([key, label]) => renderEditTextInput(key, label))}
                  </div>
                </section>
              );
  ...
  const renderInputForm = () => (
    <div className="bg-white rounded-2xl shadow-sm border border-slate-200/70">
      ...
      <form className="p-6 space-y-8" onSubmit={handleSubmit}>
        ...
        <section>
          <h4 className="text-sm font-bold text-[#071A2F] mb-4 pb-2 border-b-2 border-yellow-400 uppercase tracking-wide">Status Kepemilikan Perusahaan</h4>
        ...
        <section>
          <h4 className="text-sm font-bold text-[#071A2F] mb-4 pb-2 border-b-2 border-yellow-400 uppercase tracking-wide">Keterangan / Penghargaan K3</h4>
          <div>
        ...
        <div className="p-5 border-b border-slate-100 bg-slate-50/60 flex justify-between items-center">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-1">
              {{
                '6A': 'Kegiatan Pembinaan Ketenagakerjaan Berdasarkan KBLI',
                '6B': 'Kegiatan Pemeriksaan Ketenagakerjaan Berdasarkan KBLI',
                '6C': 'Kegiatan Pengujian Ketenagakerjaan Berdasarkan KBLI',
                '6D': 'Kegiatan Pembinaan Penegakkan Hukum Ketenagakerjaan Berdasarkan KBLI',
              }[activeMenu] ?? 'Rekap kegiatan KBLI'}
            </p>
          </div>
          <button className="px-4 py-2.5 bg-emerald-600 text-white text-sm font-semibold rounded-lg hover:bg-emerald-700 transition-all shadow-sm hover:shadow-md flex items-center gap-2 active:scale-[0.98]">
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path></svg>
              ...
              {groupedK6.map((group) => {
                ...
                return (
                  <React.Fragment key={rowId}>
                    ...
                    {isExpanded && renderDetailPanelK6(6, `Rincian Data: ${group.kota} (${group.bulan} ${group.tahun})`, group)}
                  </React.Fragment>
                );
              })}
              {groupedK6.length === 0 && (
    ...
    <div className="bg-white rounded-2xl shadow-sm border border-slate-200/70 overflow-hidden">
      <div className="p-5 border-b border-slate-100 bg-slate-50/60 flex justify-between items-center">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1">Data Penerbitan Perijinan, Keterangan Layak, Pengesahan, Rekomendasi K3</p>
        </div>
        <button className="px-4 py-2.5 bg-emerald-600 text-white text-sm font-semibold rounded-lg hover:bg-emerald-700 transition-all shadow-sm hover:shadow-md flex items-center gap-2 active:scale-[0.98]">
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path></svg>
          Export Excel
        ...
        <table className="w-full text-sm text-left">
          <thead className="text-[11px] text-slate-500 uppercase tracking-wide bg-slate-50 border-b-2 border-slate-100 font-semibold">
            <tr>
              ...
              <th className="px-5 py-4">Tahun</th>
              <th className="px-5 py-4">Kabupaten/Kota</th>
              <th className="px-5 py-4 text-center">Total Data K7</th>
              <th className="px-5 py-4 text-center">Aksi</th>
            </tr>
          </thead>
          <tbody>
            {dataK7.map((item) => {
              ...
              const totalK7 = k7FieldGroups
                .flatMap((group) => group.fields)
                .reduce((total, [key]) => total + Number(item[key] ?? 0), 0);

              const k7Fields = k7FieldGroups
                .flatMap((group) => group.fields)
              ...
              return (
                <React.Fragment key={item.id}>
                  <tr className={`border-b transition-colors ${isExpanded ? 'bg-[#071A2F]/5' : 'bg-white hover:bg-slate-50'}`}>
                    ...
                    <td className="px-5 py-3">{item.tahun}</td>
                    <td className="px-5 py-3 font-medium text-slate-800">{getKotaName(item)}</td>
                    <td className="px-5 py-3 text-center font-semibold text-[#071A2F]">{totalK7.toLocaleString()}</td>
                    <td className="px-5 py-3 text-center">
                      <div className="flex items-center justify-center gap-2">
                  ...
                  {isExpanded && renderDetailPanelK7(item)}
                </React.Fragment>
              );
            })}
            {dataK7.length === 0 && (
              <tr>
                <td colSpan="5" className="px-5 py-8 text-center text-slate-500">Belum ada data K7.</td>
              </tr>
            )}
          </tbody>
        </table>
      ...
      <form className="p-6 space-y-8" onSubmit={handleSubmitK7}>
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div>
              <label className="block text-sm font-medium text-slate-600 mb-1.5">Bulan</label>
              <select name="bulan" value={formDataK7.bulan} onChange={handleChangeK7} className="w-full border border-slate-300 rounded-lg px-3 py-2.5 text-sm transition-shadow focus:outline-none focus:ring-2 focus:ring-yellow-400">
                {['Januari','Februari','Maret','April','Mei','Juni','Juli','Agustus','September','Oktober','November','Desember'].map((bulan) => (
                  <option key={bulan} value={bulan}>{bulan}</option>
                ))}
              </select>
            ...
            <div>
              <label className="block text-sm font-medium text-slate-600 mb-1.5">Tahun</label>
              <input name="tahun" type="number" value={formDataK7.tahun} onChange={handleChangeK7} className="w-full border border-slate-300 rounded-lg px-3 py-2.5 text-sm transition-shadow focus:outline-none focus:ring-2 focus:ring-yellow-400" />
            </div>
            <div>
              <label className="block text-sm font-medium text-slate-600 mb-1.5">Kabupaten/Kota</label>
              <select name="id_kota" value={formDataK7.id_kota} onChange={handleChangeK7} className="w-full border border-slate-300 rounded-lg px-3 py-2.5 text-sm transition-shadow focus:outline-none focus:ring-2 focus:ring-yellow-400">{renderKabKotaOptions()}</select>
            </div>
          </div>
        </section>
                ...
                {group.fields.map(([key, label]) => (
                  <div key={key}>
                    ...
                    <input
                      ...
                      type="number"
                      min="0"
                      value={formDataK7[key] ?? 0}
                      onChange={handleChangeK7}
                      className="w-full border border-slate-300 rounded-lg px-3 py-2.5 text-sm transition-shadow focus:outline-none focus:ring-2 focus:ring-yellow-400 bg-white"
                    />
                  </div>
                ))}
